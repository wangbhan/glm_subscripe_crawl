...
| `target.pre_open_seconds` | 提前预热秒数 | `15` |
| `schedule.time` | 每天执行时间 (HH:MM) | `10:00` |
| `purchase.max_retries` | 最大重试次数 | `3` |
...
```
09:59:45  启动浏览器，打开页面预热
10:00:00  精确刷新页面
10:00:01  检测并点击订阅按钮
10:00:02  检测支付弹窗 → 推送通知提醒扫码
          等待用户完成支付
          → 推送成功/失败通知
```
